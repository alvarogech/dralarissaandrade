...
export default function HojePage() {
  ...
  // Engine (Fase 4) ainda nao esta conectado ao Simples Dental real.
      ...
      <main className="mx-auto w-full max-w-cockpit flex-1 px-6 py-8 md:px-10">
        {demoMode && (
          <div className="mb-6 rounded-md border border-important bg-important-bg px-4 py-2 text-sm text-important">
            Modo demonstração — sem conexão com o banco Supabase ainda. Os dados abaixo são
            fictícios (ver <code>docs/ROADMAP.md</code>). Configure{" "}
            <code>NEXT_PUBLIC_SUPABASE_URL</code> para ligar dados reais.
          </div>
        )}
